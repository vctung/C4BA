...
;(function($){
	...
	include('themes/blog_mainpage/js/history.js?redirect=true&basepath='+FJSCore.basepath)
...
!function($){
	...
	doc
		...
		.on('click','#mainNav a[href^="/"]:not([href^="//"]),#mainNav a[href^="./"]',function(e){			
	...
	FJSCore.prepareLoaded=function(root){
		$('#mainNav a[href^="/"]:not([href^="//"])',root).each(function(){
			var $this=$(this)
